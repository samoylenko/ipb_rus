...
'col__gallery_categories_images'				=> "The number of images in this category",
'col__gallery_categories_description'				=> "The category description",
'col__gallery_categories_parent'				=> "Parent category ID",
'col__gallery_categories_name'				=> "The category name",
'col__gallery_categories_last_pic_name'				=> "The caption of the last image uploaded to this category",
'col__gallery_categories_id'				=> "The category ID",
'col__gallery_categories_thumbnail'				=> "Flag that indicates if images in this category should be thumbnailed",
'col__gallery_categories_allow_comments'				=> "Flag that indicates if comments should be allowed in this category",
'col__gallery_categories_approve_images'				=> "Flag that indicates if images submitted to this category require approval",
'col__gallery_categories_password'				=> "The password for this category (if any)",
'col__gallery_categories_comments'				=> "The number of comments in this category",
'col__gallery_categories_watermark_images'				=> "Flag that indicates if images in this category should be watermarked",
'col__gallery_categories_rate'				=> "Flag that indicates if ratings are allowed in this category",
'col__gallery_categories_last_pic_id'				=> "The ID of the latest image uploaded in this category",
'col__gallery_categories_status'				=> "Flag that indicates if this category is currently open",
'col__gallery_categories_inc_post_count'				=> "Flag that indicates if images posted in this category should cause member post count to increment",
'col__gallery_categories_approve_comments'				=> "Flag that indicates if comments posted in this category should require approval",
'col__gallery_categories_allow_movies'				=> "Flag that indicates if media files are allowed in this category",
'col__gallery_categories_allow_images'				=> "Flag that indicates if images are allowed in this category",
'col__gallery_categories_album_mode'				=> "Flag that indicates if this category only directly accepts albums",
'col__gallery_categories_category_only'				=> "Flag that indicates if this category is only intended to host subcategories",
'col__gallery_albums_member_id'				=> "The ID of the member that owns this album",
'col__gallery_albums_id'				=> "The album ID",
'col__gallery_categories_images_per_page'				=> "The number of images to show per page in this category",
'col__gallery_categories_cover_img_id'				=> "The image ID that should represet this category&#39;s cover image",
'col__gallery_categories_last_pic_date'				=> "Timestamp of the last image submitted to this category",
'col__gallery_categories_mod_comments'				=> "The number of comments awaiting approval in this category",
'col__gallery_categories_mod_images'				=> "The number of images awaiting approval in this category",
'col__gallery_categories_last_member_id'				=> "The member ID who last submitted an image to this category",
'col__gallery_albums_public_album'				=> "Flag that indicates if this is a public album",
'col__gallery_albums_last_pic_date'				=> "Timestamp for the most recently uploaded image in this album",
'col__gallery_albums_category_id'				=> "The category ID this album belongs to",
'col__gallery_albums_last_pic_id'				=> "The ID of the image most recently uploaded to this album",
'col__gallery_albums_comments'				=> "The number of comments in this album",
'col__gallery_albums_images'				=> "The number of images in this album",
'col__gallery_albums_name'				=> "The album name",
'col__gallery_albums_description'				=> "The album description",
'col__gallery_albums_last_pic_name'				=> "The caption of the most recently uploaded image in this album",
'col__gallery_albums_mod_comments'				=> "Number of comments awaiting approval in this album",
'col__gallery_albums_mod_images'				=> "Number of images awaiting approval in this album",
'col__gallery_albums_parent'				=> "The parent album ID",
'col__gallery_albums_cover_img_id'				=> "The ID of the image that should represent this album&#39;s cover image",
'col__gallery_albums_friend_only'				=> "Flag that indicates if this is a friend-only album",
...
'col__gallery_albums_profile_album'				=> "Flag that indicates if this album hosts profile images",
...
'col__forum_tracker_forum_id'				=> "Forum ID member is subscribed to",
'col__forum_tracker_member_id'				=> "Member ID for subscriber",
'col__forum_tracker_start_date'				=> "Timestamp member originally subscribed to this forum",
'col__forums_id'				=> "Forum ID",
'col__tracker_topic_track_type'				=> "Subscription type (immediate, delayed, weeklydigest, dailydigest or none)",
'col__tracker_last_sent'				=> "Timestamp of last notification email sent to member for this topic",
'col__forum_tracker_last_sent'				=> "Timestamp of last notification email sent to member for this forum",
'col__tracker_member_id'				=> "Member ID for subscriber",
'col__forum_tracker_forum_track_type'				=> "Subscription type (immediate, delayed, weeklydigest, dailydigest or none)",
'col__tracker_topic_id'				=> "Topic ID member is subscribed to",
'col__forums_last_poster_id'				=> "Member ID for member who made the last post in this forum",
'col__tracker_start_date'				=> "Timestamp member originally subscribed to this topic",
...
'col__posts_post_parent'				=> "The parent post ID",
...
'col__special_avatar'				=> "Full HTML needed to display user avatar",

...
'merge_uncommitted_desc'				=> "<strong>You have %s items with uncommitted ('unsaved') changes.</strong><div class='desctext'>This means that although the items are now merged, they need to be committed ('saved') before the changes will show on your board. Please use the checkboxes and drop down to commit these changes.</div>",
...
'merge_done_desc'				=> "<strong>All your templates have been saved and are now 'live' on your board</strong><div class='desctext'>You can optionally edit them further or uncommit ('revert') the changes by using the checkboxes and drop down box.</div>",

...
'gf_view_board_warning'				=> "If the guest group cannot access the site, nobody will be able to register. If you want to force guests to log in before allowing access to the board this can be done in the Security and Privacy <a href='%s' target='_blank'>settings</a>.",
...
'g_globalperm'				=> "Global",
'gf_gtitle'				=> "Group Title<br /><span class='desctext'>(Required)</span>",
...
'gf_gicon'				=> "Group Icon Image<br />(Optional)",
'gf_gformpre'				=> "Group Formatting Prefix<br />(Optional)",
...
'gf_gformsuf'				=> "Group Formatting Suffix<br />(Optional)",
...
'gf_upersonalpho'				=> "<strong>Personal Photo Limits</strong><br />Max upload file size and dimensions",
